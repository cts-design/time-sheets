...
*/
$baseUrl = 'http://ccc.atlasforworkforce.com/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/var/www/vhosts/ccc.atlasforworkforce.com/atlas/current/webroot/';
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . 'img/public/_thumbs',
		'directory' => $baseDir . 'img/public/_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'files/public',
		'directory' => $baseDir . 'files/public',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'img/public',
		'directory' => $baseDir . 'img/public',
		'maxSize' => "16M",
