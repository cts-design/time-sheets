...
var EmployersSurvey = {
  ...
  initData: function() {
    ...
    Ext.create('Ext.data.Store', {
      ...
      id: 'surveyStore',
      idProperty: 'id',
      model: 'EmployersSurvey',
      proxy: {
        type: 'ajax',
        api: {
          create:  '/admin/employers_surveys/create',
          read:    '/admin/employers_surveys/read',
          update:  '/admin/employers_surveys/update',
          destroy: '/admin/employers_surveys/destroy'
        },
        reader: {
          type: 'json',
          root: 'surveys'
    ...
    var windowTpl = new Ext.XTemplate(
      '<div class="x-careerseeker">',
        ...
        '<div class="x-careerseeker-row">',
          '<p class="label left">Company/Organizations:</p>',
          '<p class="left">{company_organizations}</p>',
          '<br class="clear" />',
        '</div>',
        '<div class="x-careerseeker-row">',
