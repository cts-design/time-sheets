...
<<<<<<< HEAD
	...
	initData: function() {
		...
		var proxy = new Ext.data.HttpProxy({
			api: {
				create:  { url: '/admin/employers_surveys/create',  method: 'POST' },
				read:    { url: '/admin/employers_surveys/read',    method: 'GET'  },
				update:  { url: '/admin/employers_surveys/update',  method: 'POST' },
				destroy: { url: '/admin/employers_surveys/destroy', method: 'POST' }
			}
		});
