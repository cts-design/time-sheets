...
var JobOrderForms = {
  ...
  initData: function () {
    ...
    Ext.create('Ext.data.Store', {
      ...
      proxy: {
        type: 'ajax',
        api: {
          read:    '/admin/job_seeker_new_hires/read',
          destroy: '/admin/job_seeker_new_hires/destroy'
        },
        reader: {
          type: 'json',
          root: 'job_seeker_new_hires'
        },
        writer: {
          type: 'json',
          encode: true,
  ...
  initGrid: function() {
    var gridToolbar = Ext.create('Ext.toolbar.Toolbar', {
      items: [{
        id: 'deletebtn',
        text: 'Delete Job Seeker New Hire',
        icon: '/img/icons/delete.png',
        tooltip: 'Delete the selected job seeker new hire',
        disabled: true,
        scope: this,
        handler: function() {
