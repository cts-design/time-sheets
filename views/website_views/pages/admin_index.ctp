...
<div class="actions ui-widget-header">
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr>
					...
					<th class="ui-state-default"><?php echo $this->Paginator->sort(__('Slug', true), 'slug');?></th>
					<th class="ui-state-default"><?php echo $this->Paginator->sort(__('Published', true), 'published');?></th>
