...
<?php if (!empty($programResponse) && $programResponse['Program']['cert_type'] !== 'none'): ?>
  <div id="ResponseComplete">
    <p>
    ...
    <p class="left right-mar-10 top-mar-10 label"><strong><?php __('Program:') ?> </strong></p>
    <p class="left top-mar-10"><?php echo $programResponse['Program']['name'] ?></p>
    <br class="clear" />
    <p class="left right-mar-10 label"><strong><?php __('Registrant name:') ?> </strong></p>
    <p class="left">
      <?php echo ucfirst($programResponse['User']['firstname']) . ' ' . ucfirst($programResponse['User']['lastname']) ?>
    </p>
    <br class="clear" />
    <p class="left right-mar-10 label" ><strong><?php __('Approved on:') ?> </strong></p>
