<div id="crumbWrapper">
    ...
    <?php echo $crumb->getHtml('Forms', null, 'unique'); ?></div>
...
<div class="actions ui-widget-header">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $form['Form']['id']), array('class'=>'edit')); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $form['Form']['id']), array('class'=>'delete'), sprintf(__('Are you sure you want to delete # %s?', true), $form['Form']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
